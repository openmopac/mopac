...
!
    ...
    do i = 1, numat    
     ...
     MODULE sdot_I   
      INTERFACE
!...Generated by Pacific-Sierra Research 77to90  4.4G  21:50:21  09/04/07  
      REAL FUNCTION sdot (N, SX, INCX, SY, INCY) 
      integer, INTENT(IN) :: N 
      real, DIMENSION(1), INTENT(IN) :: SX 
      integer, INTENT(IN) :: INCX 
      real, DIMENSION(1), INTENT(IN) :: SY 
...
!...Translated by Pacific-Sierra Research 77to90  4.4G  21:50:21  09/04/07  
...
!
      ...
      return  
            ...
            MODULE scopy_I   
      INTERFACE
!...Generated by Pacific-Sierra Research 77to90  4.4G  21:51:49  09/04/07  
...
!...Translated by Pacific-Sierra Research 77to90  4.4G  21:51:49  09/04/07  
!...Switches: -rl INDDO=2 INDIF=2 
!-----------------------------------------------
!   I n t e r f a c e   B l o c k s
!-----------------------------------------------
